...
export class aPolAAVEMint extends ethereum.Event {
  get params(): aPolAAVEMint__Params {
    return new aPolAAVEMint__Params(this);
  }
}

export class aPolAAVEMint__Params {
  _event: aPolAAVEMint;

  constructor(event: aPolAAVEMint) {
    this._event = event;
  }
...
export class aPolAAVETransfer extends ethereum.Event {
  get params(): aPolAAVETransfer__Params {
    return new aPolAAVETransfer__Params(this);
  }
}

export class aPolAAVETransfer__Params {
  _event: aPolAAVETransfer;

  constructor(event: aPolAAVETransfer) {
    this._event = event;
  }
...
export class aPolAAVE__getAccountSnapshotResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class aPolAAVE extends ethereum.SmartContract {
  static bind(address: Address): aPolAAVE {
    return new aPolAAVE("aPolAAVE", address);
  }
  ...
  getAccountSnapshot(account: Address): aPolAAVE__getAccountSnapshotResult {
    let result = super.call(
      "getAccountSnapshot",
    ...
    return new aPolAAVE__getAccountSnapshotResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getAccountSnapshot(
    account: Address
  ): ethereum.CallResult<aPolAAVE__getAccountSnapshotResult> {
    let result = super.tryCall(
      "getAccountSnapshot",
      "getAccountSnapshot(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    return ethereum.CallResult.fromValue(
      new aPolAAVE__getAccountSnapshotResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
