...
export function createContractMintEvent(
  minter: Address,
  mintAmount: BigInt,
  mintTokens: BigInt
): ContractMint {
  let contractMintEvent = changetype<ContractMint>(newMockEvent())

  contractMintEvent.parameters = new Array()

  contractMintEvent.parameters.push(
