...
import {
  ...
  ReservesReduced,
  aPolAAVETransfer
} from "../generated/aPolAAVE/aPolAAVE"
...
export function createaPolAAVEMintEvent(
  minter: Address,
  mintAmount: BigInt,
  mintTokens: BigInt
): aPolAAVEMint {
  let aPolAaveMintEvent = changetype<aPolAAVEMint>(newMockEvent())

  aPolAaveMintEvent.parameters = new Array()

  aPolAaveMintEvent.parameters.push(
...
export function createaPolAAVETransferEvent(
  from: Address,
  to: Address,
  amount: BigInt
): aPolAAVETransfer {
  let aPolAaveTransferEvent = changetype<aPolAAVETransfer>(newMockEvent())

  aPolAaveTransferEvent.parameters = new Array()

  aPolAaveTransferEvent.parameters.push(
